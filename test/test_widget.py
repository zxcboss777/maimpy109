...
def mask_account_card(input_data, expected_output):
...
def get_date():
    ...
    def get_date_correct(input_date, expected_output):
        """
    ...
    def get_date_invalid_input(input_date):
        """
